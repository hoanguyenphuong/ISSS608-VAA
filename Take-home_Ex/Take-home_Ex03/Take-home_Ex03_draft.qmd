...
![](images/clipboard-3842308688.png)
...
![](images/clipboard-2973400935.png)
...
#### [4.2.3.3]{style="color:#d496d4; background:none;"} **Pseudonym General Usage**

![](images/clipboard-3919762440.png)
...
#### [4.2.3.4]{style="color:#d496d4; background:none;"} **Pseudonym Specific Mentions**

![](images/clipboard-1305175943.png)
...
• shiny: Easy web apps for data science without the compromises. Enables reactive interfaces and layout structure.

• dplyr: A grammar of data manipulation, making data wrangling concise, fast, and readable.

• ggplot2: A versatile and widely used R package for creating elegant data visualizations based on the Grammar of Graphics (used for bar charts, heatmaps).

• visNetwork: Enables interactive network visualizations in R using the vis.js JavaScript library (used for rendering the communication cluster graph).
